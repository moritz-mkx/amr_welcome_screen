...
function AdminPanel() {
  ...
  const [config, setConfig] = useState({ slideInterval: 5000, transitionDuration: 1000, timeFontSize: 160, dateFontSize: 42, logoMaxWidth: 320, logoMaxHeight: 120 });
